...
class ApiService {
  ...
  static Future<List<dynamic>> getClients() async {
    final res = await http
        .get(Uri.parse('$baseUrl/clients'), headers: await _authHeaders())
        .timeout(_timeout);
  ...
  static Future<Map<String, dynamic>> getClient(String id) async {
    final res = await http
        .get(Uri.parse('$baseUrl/clients/$id'), headers: await _authHeaders())
        .timeout(_timeout);
  ...
  static Future<List<dynamic>> getTemplates() async {
    final res = await http
        .get(Uri.parse('$baseUrl/templates'), headers: await _authHeaders())
        .timeout(_timeout);
  ...
  static Future<List<dynamic>> getColdClients() async {
    final res = await http
        .get(Uri.parse('$baseUrl/cold-clients'), headers: await _authHeaders())
        .timeout(_timeout);
  ...
  /// Logs out the WhatsApp session. Backend cascades to a full instance delete
  /// if Evolution's logout is stuck — the response's `hardReset` flag reports
  /// which path was taken so the UI can prompt the user to scan a new QR.
  static Future<Map<String, dynamic>> whatsappDisconnect() async {
    final res = await http
        .post(
  ...
  static Future<List<dynamic>> getLabels() async {
    final res = await http
        .get(Uri.parse('$baseUrl/labels'), headers: await _authHeaders())
        .timeout(_timeout);
  ...
  static Future<void> deleteLabel(String id) async {
    final res = await http
        .delete(Uri.parse('$baseUrl/labels/$id'), headers: await _authHeaders())
        .timeout(_timeout);
  ...
  static Future<List<dynamic>> getCampaigns() async {
    final res = await http
        .get(Uri.parse('$baseUrl/campaigns'), headers: await _authHeaders())
        .timeout(_timeout);
  ...
  static Future<Map<String, dynamic>> getCampaign(String id) async {
    final res = await http
        .get(Uri.parse('$baseUrl/campaigns/$id'), headers: await _authHeaders())
        .timeout(_timeout);
